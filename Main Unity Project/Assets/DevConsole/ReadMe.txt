...
2) The constructor takes a delegate as a reference to the method. Note that the signature should match the Generics types specified.
    2.1) Alternatively, before passing the delegate, a string can be specified. That will be the alias for the command showing on the console.
    2.2) If no string is used, the alias for the command will be the full name of the method, including its class.
