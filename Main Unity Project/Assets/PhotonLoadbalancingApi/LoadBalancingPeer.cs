...
namespace ExitGames.Client.Photon.LoadBalancing
{
    ...
    public class LoadBalancingPeer : PhotonPeer
    {
        ...
        /// <returns>If the operation could be sent (requires connection).</returns>
        public virtual bool OpSetPropertiesOfActor(int actorNr, Hashtable actorProperties, Hashtable expectedProperties = null)
        {
            if (this.DebugOut >= DebugLevel.INFO)
            {
        ...
        /// <returns>If the operation could be sent (has to be connected).</returns>
        public virtual bool OpSetPropertiesOfRoom(Hashtable gameProperties, bool webForward, Hashtable expectedProperties = null)
        {
            if (this.DebugOut >= DebugLevel.INFO)
            {
